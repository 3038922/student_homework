...
int main()
{
    ...
    // char emperorName[50];
    // int choice;
    // char names[6][20] = {"貂蝉", "杨玉环", "不知火舞", "西施", "郭德纲"};
    // char levellNames[5][10] = {"贵人", "嫔妃", "贵妃", "皇贵妃", "皇后"};
    // int levels[] = {1, 2, 0, 0, 0, -1};
    // int loves[] = {100, 100, 100, 100, 100, -1};
    // // std::cout << "测试代码:查看当前嫔妃的状态" << std::endl;
    // // for (i = 0; i < count; i++)
    // // {
    // //     std::cout<<<<"\t"
    // // }
    // // std::cout << "请输入当前登基皇帝名号" << std::endl;
    // scanf("%s", emperorName);
    // std::cout << "皇帝" << emperorName << "驾临,有事上奏,无事退朝!" << std::endl;
    // std::cout << "1、皇帝下旨选妃：\t\t (增加功能) " << std::endl;
    // std::cout << "2、翻盘宠幸：\t\t (修改状态功能) " << std::endl;
    // std::cout << "3、打入冷宫!\t\t (删除功能) " << std::endl;
    // std::cout << "4、单独召见爱妃去小树林做纯洁的事 " << std::endl;
    // std::cout << "陛下请选择" << std::endl;
    // scanf("%d", &choice);
    // switch (choice)
    // {
    //     case 1:
